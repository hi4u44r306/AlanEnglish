...
-- Restored from the exact migration already applied to the shared Supabase
-- project. Keeping the deployed schema source in Git makes later speaking
-- migrations reproducible without changing the existing production function.
