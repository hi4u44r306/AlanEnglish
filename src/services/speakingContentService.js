...
export const createWorkbookOneGreetingsQuestionSet = (firebaseUser, bookId) => callSpeakingContent(firebaseUser, "create_workbook_1_greetings", { book_id: bookId });
export const createWorkbookOneCuratedQuestionSet = (firebaseUser, bookId, action) => callSpeakingContent(firebaseUser, action, { book_id: bookId });
...
export const getSpeakingQuestionAudioPreview = (firebaseUser, questionSetId, questionId, purpose = "model_answer") => (
    callEdgeFunction("speaking-tts-manager", firebaseUser, {
        action: "preview_question_audio", question_set_id: questionSetId, question_id: questionId, purpose
    })
);
