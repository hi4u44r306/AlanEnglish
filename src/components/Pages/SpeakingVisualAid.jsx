...
const Flag = ({ value }) => {
    if (value === "taiwan") return <svg viewBox="0 0 240 150" aria-hidden="true"><rect width="240" height="150" fill="#e63b38" /><rect width="100" height="88" fill="#1f4b91" /><g transform="translate(50 44)" fill="#fff">{Array.from({ length: 12 }, (_, index) => <path key={index} d="M-4-9h8L0-34Z" transform={`rotate(${index * 30})`} />)}<circle r="18" /><circle r="8" fill="#1f4b91" /></g></svg>;
