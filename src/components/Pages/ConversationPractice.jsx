...
const extractNumber = rawText => {
    ...
    for (let index = 0; index < tokens.length; index += 1) {
        ...
        if (token === "one" && nextToken === "hundred") {
            return 100;
        }
...
const extractGrade = rawText => {
    ...
    const word = Object.keys(GRADE_WORDS).find(item =>
        text.includes(item)
    );
        ...
        evaluate: answer => {
            ...
            return {
                ...
                success: valid
                    ...
                    : "",
                retry:
                    "I didn't catch your age. Try: I'm eleven years old."
            };
        }
    },
    {
        ...
        evaluate: answer => {
            ...
            const valid =
                grade !== null ||
                containsAny(text, ["grader", "grade"]);

            return {
                correct: valid,
                success: grade
                    ? `Nice! You're in grade ${grade}.`
                    : "Nice! I understood your grade.",
                retry:
                    "Try including your grade, for example: I'm in fifth grade."
            };
        }
    },
    {
        ...
        samples: [
            "I go to Happy Elementary School.",
            "I study at Sunshine Elementary School.",
            "My school is Green Elementary School."
        ],
        evaluate: answer => {
            const text = normalize(answer);
            ...
            return {
                correct: valid,
                success:
                    "Excellent! Now your new friend knows where you study.",
                retry:
                    "Try: I go to ___ Elementary School."
            };
        }
    },
    {
        ...
        translation: "你家裡有幾個人？",
        hint:
            "例如 There are four people in my family.",
        samples: [
        ...
        evaluate: answer => {
            ...
            return {
                correct: valid,
                success: valid
                    ? `Got it! There are ${count} people in your family.`
                    : "",
                retry:
                    "Tell me a number, for example: There are four people in my family."
            };
        }
    },
    {
        ...
        evaluate: answer => {
            ...
            return {
                correct: valid,
                success:
                    "Sounds fun! You told me about your hobby.",
                retry:
                    "Try: I like to play basketball."
            };
        }
    },
    {
        ...
        translation:
            "不好意思，你知道火車站在哪裡嗎？",
        hint:
            "如果不知道，不需要亂指路。可以直接說 Sorry, I don't know.",
        samples: [
            "Sorry, I don't know.",
            "I'm sorry. I'm not sure.",
            "Sorry, you can ask that police officer."
        ],
        evaluate: answer => {
            const text = normalize(answer);

            const safeUnknown = containsAny(text, [
                "don't know",
                "do not know",
                "not sure",
                "ask the police",
            ...
            const direction = containsAny(text, [
                "go straight",
                "turn left",
                "turn right",
                "over there",
            ...
            return {
                ...
                retry:
                    "If you don't know the way, say: Sorry, I don't know."
            };
        }
    },
    {
        ...
        translation:
            "順帶一問，你空閒時通常喜歡和同學一起做什麼？",
        hint:
            "這一題故意比較長。聽不懂時不要猜，請對方再說一次或說慢一點。",
        samples: [
        ...
        evaluate: answer => {
            ...
            return {
                correct: valid,
                success:
                    "Excellent real-world English! Asking for clarification is much better than pretending to understand.",
                retry:
                    "Try: Could you say that again, please?"
            };
        }
    },
    {
        ...
        evaluate: answer => {
            ...
            return {
                correct: valid,
                success:
                    "Mission complete! You finished a real English conversation.",
                retry:
                    "Try: Nice talking to you, too. Bye!"
            };
        }
    }
];
...
function ConversationPractice() {
    ...
    const [
        ...
        },
        {
            speaker: "alex",
            text:
                SCENARIO_STEPS[0].question
        }
    ]);

    const step =
        SCENARIO_STEPS[stepIndex];
        ...
        async () => {
            ...
            recognition.onerror =
                event => {
                    const errorMap = {
                        "not-allowed":
                            "麥克風或語音辨識權限被拒絕，請允許權限後再試。",
                        "audio-capture":
                            "找不到可用的麥克風。",
                        "no-speech":
                            "沒有聽到清楚的英文，請靠近麥克風再說一次。",
                        network:
                            "瀏覽器語音辨識服務暫時無法連線，請稍後再試或使用文字輸入。"
                    };
                ...
                previous => [
                    ...previous,
                    {
                        speaker:
                            "system",
                        text:
                            "Mission complete! You handled the whole conversation in English."
                    }
                ]
            );
    ...
    const restartMission =
        () => {
            ...
            try {
                ...
                console.warn(
                    "Speech recognition restart cleanup error:",
                    error
                );
            }
    ...
    if (
        ...
        return (
            <main className="conversation-page">
                <div className="conversation-cloud-loading">
                    正在從 Alan English
                    雲端載入英文對話進度...
                </div>
            </main>
    ...
    return (
        <main className="conversation-page">
            ...
            <section
                className={`conversation-cloud-banner ${isDemoMode
                        ? "demo"
                        : cloudStatus
                    }`}
            >
                ...
                <div className="conversation-chat-card">
                    ...
                    {!completed ? (
                        <div className="conversation-practice-panel">
                            ...
                            <div
                                className={`speaking-control ${listening
                                        ? "is-listening"
                                        : ""
                                    }`}
                            >
                                ...
                                {listening && (
                                    <div className="speech-live-console">
                                        <div className="speech-meter-row">
                                            <span
                                                className={`speech-status-dot ${speechStarted
                                                        ? "detected"
                                                        : ""
                                                    }`}
                                            />
                                        ...
                                        <button
                                            type="button"
                                            className="speech-finished-button"
                                            onClick={() =>
                                                finishSpeechSession(
                                                    "manual"
                                                )
                            ...
                            {evaluation && (
                                <div
                                    className={`conversation-feedback ${evaluation.correct
                                            ? "correct"
                                            : "retry"
                                        }`}
                                >
                        ...
                        <div className="conversation-complete-card">
                            ...
                            <p>
                                你已經練習名字、年齡、年級、學校、家庭、興趣、問路、聽不懂時的反應，以及自然道別。
                            </p>
