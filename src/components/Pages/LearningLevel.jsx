...
function LearningLevel() {
    ...
    return (
        <main className="platform-page">
            <header className="platform-hero"><div><span className="platform-eyebrow">LEARNING LEVEL</span><h1>我的等級</h1><p>看看已解鎖的教材，準備好再挑戰下一級。</p></div><Link className="platform-secondary" to="/student/leaderboard">看排行榜</Link></header>
