...
function MembershipAdmin() {
    ...
    const load = useCallback(async () => {
        ...
        setLoading(true);
        try {
            const [dashboard, mail] = await Promise.all([getMembershipAdminDashboard(firebaseUser), getGuardianEmailStatus(firebaseUser)]);
            setData(dashboard);
            setEmailStatus(mail);
        ...
        } catch (error) { toast.error(error.message || "會員管理資料讀取失敗"); }
