...
1. A–Z 與 P14～P17 的 curated draft templates。
2. 後端 `alphabet_round`／`letter_spelling` 完整答案比對。
3. 前端洗牌、3 秒提示、錯誤回到第一題及重聽／重玩流程。

P21／P22 同步建立通用介面與契約測試，但正式題目要等圖片及答案人工核准後才匯入。
