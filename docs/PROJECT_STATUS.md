...
- P2 好友頭貼預覽（本機完成，尚未推送或部署）：好友搜尋、邀請、好友名單與封鎖清單可顯示既有頭貼；圖片按鈕可開啟可關閉、支援 Esc 的放大預覽。為保護未成年學生影像，系統預設頭貼可在完整暱稱／好友碼搜尋時顯示；自行上傳的相片僅在雙方好友關係已接受後，由 `student-social` 簽發 15 分鐘短效網址，不提供固定公開連結。相關頁面測試、社交合約測試與 Edge Function 語法檢查已通過；尚待 Production build 與測試站實機驗收。
