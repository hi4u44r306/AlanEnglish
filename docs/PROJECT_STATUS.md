...
- 驗證與發布：先前題庫與 Navbar 前端測試 12/12、Production build、`git diff --check` 通過；固定測試站 deploy `6aa2a6fda35aa67687a34936` 已上線，登入在校學生已確認人物不再渲染、Workbook 1／2 分組與生活主題切換正常。PR #104 已建立；因分支與 `main` 有衝突，正在合併最新 `main`、重新驗證並更新測試站。
