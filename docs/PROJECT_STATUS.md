...
本次聽力播放動畫與看圖補句手機版面（2026-09-18，尚未部署）：
...
- 驗證：targeted 2 suites／8 tests、完整前端 72 suites／279 tests、Production build 與 390×844 靜態視覺檢查均通過；手機句型計算值為 20px、單字背景透明、50px 播放鍵內的等化器為 26×24px，且無水平溢位。PR、正式部署與線上驗收待完成。
