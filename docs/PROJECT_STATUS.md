...
本次 Workbook 3 P4 學生關卡圖片部署修復（2026-09-22，待本批正式部署）：
...
- 本批會將「關卡是 mixed」與「單題實際題型」分開處理：讀取時依每題已核准 interaction 取回短效私人圖片與補句音檔；評分與完成時也以該單題類型比對答案。題庫、R2 圖片、學生進度與資料庫不會被修改。
