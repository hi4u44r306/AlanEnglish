...
- 口說大挑戰版面與學生 Navbar 收斂：原本會同時渲染題庫全部小題，加入人物與圖卡後容易造成一頁堆疊、閱讀焦點混亂；已改為一次顯示一題，使用題號、上一題／下一題切換，切題時會停止前一題示範語音。學生桌面 Navbar 將「AI 教材」與「口說大挑戰」收進新的「AI 練習」下拉選單；手機側邊欄維持直接學習入口。相關前端測試、Production build 與測試站驗收待執行。
