...
- 教材包目前暫停公開販售，不得顯示購買、加入購物車或結帳入口。
- 未來實體教材購買者以同一個已驗證 Email 領取永久教材權限及自兌換日起 90 天網站使用權；90 天不自動續費。
- 權限從兌換日開始計算，且只能看到自己購買或取得權限的教材。
- 90 天後可選擇每月 NT$299 延續已擁有教材的網站功能；自主學習平台不含新教材且不解鎖下一級。
- 不得收到英文班作業。

### 英文班在校學生

- 英文班內部方案為每月 NT$599，包含網站、班級教材、班級作業與 AI 教材；不得寫進公開網站或開放公開付款。
- 可以使用班級教材及班級作業。
- 學生班級為 E1、E3、E5、E7。
...
- 保留原有學習紀錄。
- 不再收到新的班級作業。
- 可用每月 NT$299 繼續自主學習，AI 教材可另加購每月 NT$299。
- 自行購買的教材權限不能消失。
